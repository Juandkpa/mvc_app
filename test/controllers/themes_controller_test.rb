...
class ThemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post themes_url, params: { theme: { integer: @theme.integer, name: @theme.name, string: @theme.string, type_t: @theme.type_t } }
    end
  ...
  test "should update theme" do
    patch theme_url(@theme), params: { theme: { integer: @theme.integer, name: @theme.name, string: @theme.string, type_t: @theme.type_t } }
